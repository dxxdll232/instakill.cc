...
function showAsciiAndInfo() {
  ...
  const infoHTML = `
    <div style="margin: auto; opacity: 0; transition: opacity 1s ease-in;">
      ...
      <div class="info-item" style="--delay: 3; color: #FFA500">Moto: "Crip Walkin On Your Internet Presence"</div>
      <div class="info-item" style="--delay: 4; color: #FF8C00">Group: https://instakill.cc</div>
      <div class="info-item" style="--delay: 5; color: #FF6347">We are a Minecraft focused group who can investigate and takedown pedophiles behind a screen</div>
      <div class="info-item" style="--delay: 6; color: #FF4500">No matter the anonymity we can tackle it</div>
      <div class="info-item" style="--delay: 7; color: #FF8C00">Visit https://minetrace.sh/ to learn more.</div>
    </div>
  `;
